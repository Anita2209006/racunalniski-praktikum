...
\[
\text{velikostTabele} = \text{številoDelovnihdni} \cdot \text{številoUrNaDan}
\]
...
\subsubsection{Požrešna metoda} % podrazdelek
...
zato si je smiselno podrobneje ogledati posamezne korake.
   ...
   Ko preverimo vse proste termine vseh predavalnic, vstavimo srečanje$_i$ S
